    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                vm.state.collect { st ->
                    when (st) {
                        is app.surrealar.gnss.capture.ObservationSession.State.Capturing -> {
                        ...
                        is app.surrealar.gnss.capture.ObservationSession.State.Complete -> {
                        ...
                        is app.surrealar.gnss.capture.ObservationSession.State.Paused -> {
