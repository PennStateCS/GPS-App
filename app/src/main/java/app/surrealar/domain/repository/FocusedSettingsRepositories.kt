 ...
 * single [app.surrealar.data.settings.repository.SettingsRepositoryImpl] over the one
...
interface MapSettingsRepository {
    val mapSettings: Flow<app.surrealar.ui.rendermap.MapSettings>
    suspend fun setMapSettings(settings: app.surrealar.ui.rendermap.MapSettings)
}
