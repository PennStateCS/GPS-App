 ...
 * fallbacks ([app.surrealar.data.settings.datastore.SettingsLocalDataSource]) and any UI
...
object SettingsDefaults {
    ...
    val stakeout = app.surrealar.settings.model.StakeoutSettings()

    /** Durable map display defaults (applied when the map opens in a fresh session). */
    val map = app.surrealar.ui.rendermap.MapSettings()
     ...
     */
    val externalReceiverSettings = app.surrealar.settings.model.ExternalReceiverSettings(
