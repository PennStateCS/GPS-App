package app.surrealar.architecture
...
class ArchitectureGuardTest {
    ...
    fun `no new SurveyingApp_settingsRepo service-locator usage`() {
        val allow = setOf(
            ...
            "app/surrealar/di/SettingsModule.kt",
            ...
            "app/surrealar/util/DiagnosticReportExporter.kt",
    ...
    fun `no direct AppDatabase construction outside DI`() {
        val allow = setOf(
            ...
            "app/surrealar/di/DatabaseModule.kt",
        )
        enforce(
    ...
    fun `provider activation only through GnssSourceCoordinator`() {
        val allow = setOf(
            ...
            "app/surrealar/gnss/source/GnssSourceCoordinator.kt",
            // PERMANENT: the SourceSettings.setActiveProvider definition itself.
            "app/surrealar/gnss/source/SourceSettings.kt",
        )
        enforce(
    ...
    fun `only one settings Preferences DataStore delegate exists`() {
        ...
        val allow = setOf(
            ...
            "app/surrealar/data/settings/datastore/Preferences.kt",
        )
        enforce(
