package app.surrealar.data.settings

import androidx.datastore.core.DataStore
import androidx.datastore.preferences.core.PreferenceDataStoreFactory
import androidx.datastore.preferences.core.Preferences
import androidx.datastore.preferences.core.edit
import app.surrealar.data.settings.datastore.SettingsKeys
import app.surrealar.data.settings.datastore.SettingsLocalDataSource
import app.surrealar.data.settings.migration.SettingsMigrationRunner
...
import app.surrealar.domain.repository.GnssCaptureSettingsRepository
...
import app.surrealar.settings.model.ExternalReceiverProfile
import app.surrealar.settings.model.ExternalReceiverSettings
import app.surrealar.settings.model.StakeoutSettings
...
class SettingsRepositoryRoundTripTest {
    ...
    fun `map settings round-trip with stable enum tokens`() = runBlocking {
        val s = app.surrealar.ui.rendermap.MapSettings(
            defaultMapType = com.google.android.gms.maps.GoogleMap.MAP_TYPE_HYBRID,
            defaultGridMode = app.surrealar.ui.rendermap.MapGridMode.FINE,
            defaultPointLabelMode = app.surrealar.ui.rendermap.PointLabelMode.DISTANCE,
    ...
    fun `map settings tolerate legacy enum-name tokens and unknown map type`() = runBlocking {
        ...
        assertEquals(app.surrealar.ui.rendermap.MapGridMode.COARSE, s.defaultGridMode)
        assertEquals(app.surrealar.ui.rendermap.PointLabelMode.ELEVATION, s.defaultPointLabelMode)
